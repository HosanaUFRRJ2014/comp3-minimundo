...
/**
 * Servlet implementation class CtrCriarContrato
 */
@WebServlet("/CtrCriarContrato")
public class CtrCriarContrato extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CtrCriarContrato() {
        super();
	...
	//	String vContrato = request.getParameter("valorContrato");
		...
		if(comissao  == null /*|| vContrato  == null || pz == null*/)// ?
		{
			    ...
			    sessao.setAttribute("voltar", "frontCriarContrato.jsp");
				//erro
